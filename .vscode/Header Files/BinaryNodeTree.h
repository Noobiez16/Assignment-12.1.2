...
// preorder traversal.
BinaryNode<ItemType>* find(BinaryNode<ItemType> *aTree, const ItemType
&findItem,bool &success) const;
...
template<class ItemType>
BinaryNode<ItemType>*
BinaryNodeTree<ItemType>::removeValue(BinaryNode<ItemType>*subTreePtr,const ItemType
target,bool& success)
{
...
template<class ItemType>
BinaryNode<ItemType>*
BinaryNodeTree<ItemType>::moveValuesUpTree(BinaryNode<ItemType>*nodePtr)
{
...
template < class ItemType>
BinaryNode<ItemType>* BinaryNodeTree<ItemType>::find(BinaryNode<ItemType> *aTree,const
ItemType &findItem, bool &success) const {
...
//Funciona se corrigio
template < class ItemType>
void BinaryNodeTree<ItemType>::attachLeftSubtree(BinaryNodeTree<ItemType>* leftTreePtr)
const throw(PrecondViolatedExcep)
{
	if (isEmpty())
		...
		if (rootPtr->getLeftChildPtr() != nullptr)
			throw PrecondViolatedExcep("TreeException: Can not overwrite left "
				"subtree");
		else {
...
//Funciona se corrigio
template < class ItemType>
void BinaryNodeTree<ItemType>::attachRightSubtree(BinaryNodeTree<ItemType>* rightTreePtr)
const throw(PrecondViolatedExcep)
{
	if (isEmpty())
		throw PrecondViolatedExcep("TreeException: Empty tree");
		...
		if (rootPtr->getRightChildPtr() != nullptr)
			throw PrecondViolatedExcep("TreeException: Can not overwrite right "
				"subtree");
		else {
