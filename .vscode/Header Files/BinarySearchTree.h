...
public:
	...
	//------------------------------------------------------------
	BinarySearchTree();
    BinarySearchTree(const BinaryNodeTree(rootItem));
...
template<class ItemType>
inline void BinarySearchTree<ItemType>::setRootData(const ItemType& newData) const
{
}
template < class ItemType>
void BinarySearchTree<ItemType>::setRootData(const ItemType& newData) const throw
